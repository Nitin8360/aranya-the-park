  ...
  return (
    <section id="amenities" className="section-spacing bg-dark-950 text-ivory relative overflow-hidden">
      ...
      <Container>
        ...
        {/* ─── Modern Glass Amenity Pill Selector ─── */}
        <div className="flex items-center justify-start lg:justify-center gap-2 overflow-x-auto overflow-touch pb-4 mb-10 px-2 sm:px-0">
          {amenitiesData.map((item, idx) => {
            ...
            return (
              <button
                ...
                className={`px-4 sm:px-5 py-2.5 text-[11px] font-sans uppercase tracking-[0.14em] font-medium rounded-full shrink-0 transition-all duration-300 cursor-pointer ${
                  isActive

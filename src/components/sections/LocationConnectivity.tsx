  ...
  return (
    <section id="location" className="section-spacing bg-dark-900 text-ivory relative overflow-hidden">
      ...
      <Container>
        ...
        {/* ─── Map as Part of the Storytelling ─── */}
        <div className="glass-panel p-6 sm:p-10 lg:p-12 rounded-[6px] shadow-[0_25px_60px_rgba(0,0,0,0.7)]">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
            ...
            <div
              ...
              className="lg:col-span-7 relative aspect-[16/10] bg-black overflow-hidden cursor-pointer group shadow-2xl rounded-[4px] border border-white/[0.08]"
            >
              <img
                src="/assets/location-map-infra.png"
                alt="Aranya The Park Location & Connectivity Map"
                className="w-full h-full object-cover brightness-[0.88] group-hover:brightness-100 group-hover:scale-[1.02] transition-all duration-700"
              />
              <div className="absolute inset-0 bg-dark-950/20 group-hover:bg-dark-950/5 transition-all duration-500" />

              {/* Hover Cue */}
              <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                <div className="flex items-center gap-2.5 px-5 py-2.5 bg-champagne-400 text-dark-950 rounded-full shadow-xl">
                  <Maximize2 size={16} />
            ...
            {/* Right: Infrastructure Narrative & Modal Triggers */}
            <div className="lg:col-span-5 space-y-6">
              ...
              <div className="pt-2 flex flex-wrap items-center gap-3">
                ...
                <button
                  ...
                  className="py-3.5 px-6 text-xs font-sans font-semibold tracking-[0.16em] uppercase text-ivory-muted hover:text-ivory border border-white/[0.12] hover:border-champagne-400/50 rounded-[3px] glass-panel-subtle transition-all duration-300 cursor-pointer"
                >

...
export const LeadFormModal: React.FC<LeadFormModalProps> = ({
  ...
  return (
    <Modal
      ...
      title={isSubmitted ? 'Enquiry Confirmed' : defaultPurpose}
      subtitle={isSubmitted ? `Reference ID: ${generatedLeadId}` : 'Aranya The Park · Malad West, Mumbai'}
      maxWidth="md"
    >
      {isSubmitted ? (
        ...
        <div className="py-6 text-center space-y-5 animate-in fade-in duration-300">
          ...
          <div className="p-3.5 bg-white/[0.02] border border-white/[0.08] rounded-[3px] text-xs text-ivory-muted text-left space-y-1 max-w-sm mx-auto">
          ...
          <div className="pt-2 flex flex-col gap-2.5 max-w-sm mx-auto">
            ...
            <a
              ...
              className="w-full py-2.5 px-4 bg-white/[0.04] border border-white/[0.1] text-ivory hover:text-champagne-300 font-sans text-xs uppercase tracking-widest font-medium inline-flex items-center justify-center gap-2 transition-colors rounded-[3px]"
            >
              <Phone size={13} />
              <span>Direct Concierge Desk: {projectData.phone}</span>
            </a>

            <button
              onClick={handleResetAndClose}
              className="py-2 text-ivory-muted/60 hover:text-ivory text-xs font-sans uppercase tracking-wider transition-colors cursor-pointer"
            >
              Close Window
            </button>
          </div>
        ...
        /* Minimalist, Restrained Luxury Enquiry Form */
        <form onSubmit={handleSubmit} className="space-y-4 font-sans text-xs pt-1">
          {/* Subtle RERA & Privacy Indicator */}
          <div className="flex items-center justify-between px-3 py-2 bg-white/[0.02] border border-white/[0.08] rounded-[3px] text-[11px] text-ivory-muted">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
            <div className="space-y-1">
              ...
              <input
                ...
                className="w-full bg-white/[0.04] border border-white/[0.12] rounded-[3px] px-3 py-2.5 text-ivory placeholder:text-ivory-muted/30 focus:outline-none focus:border-champagne-400 focus:bg-white/[0.06] transition-all"
              />
            </div>
            ...
            <div className="space-y-1">
              ...
              <div className="relative flex items-center">
                <span className="absolute left-3 text-ivory-muted/50 font-mono text-xs">+91</span>
                <input
                  type="tel"
                  required
                  pattern="[0-9]{10}"
                  ...
                  className="w-full bg-white/[0.04] border border-white/[0.12] rounded-[3px] pl-11 pr-3 py-2.5 text-ivory placeholder:text-ivory-muted/30 focus:outline-none focus:border-champagne-400 focus:bg-white/[0.06] transition-all"
                />
              </div>
            </div>
          </div>
          ...
          <div className="space-y-1">
            <label className="text-[11px] uppercase tracking-wider text-ivory-muted/80 font-medium block">
              Email Address <span className="text-ivory-muted/50 lowercase">(optional for digital deck)</span>
            </label>
            <input
              type="email"
              value={email}
              ...
              className="w-full bg-white/[0.04] border border-white/[0.12] rounded-[3px] px-3 py-2 text-ivory placeholder:text-ivory-muted/30 focus:outline-none focus:border-champagne-400 focus:bg-white/[0.06] transition-all"
            />
          </div>
            ...
            <div className="grid grid-cols-3 gap-2">
              {[
                ...
                <button
                  ...
                  className={`py-2 px-2 text-center rounded-[3px] border font-sans text-xs tracking-wider transition-all cursor-pointer flex items-center justify-center gap-1.5 ${
          ...
          <div className="space-y-1">
            ...
            <textarea
              ...
              className="w-full bg-white/[0.04] border border-white/[0.12] rounded-[3px] px-3 py-2 text-ivory placeholder:text-ivory-muted/30 focus:outline-none focus:border-champagne-400 focus:bg-white/[0.06] transition-all resize-none"
            />
          </div>
          ...
          <div className="pt-1 flex items-start gap-2.5">
            <input
              ...
              required
            />
            <label htmlFor="consent-check" className="text-[10px] text-ivory-muted/60 leading-relaxed font-light cursor-pointer select-none">
              I authorize representatives of Aranya The Park (Zaveri Realty & BKM Mindspace) to contact me via Call, WhatsApp, or Email with floor plans, pricing, and project updates. Zero brokerage, direct developer interaction.
            </label>
          </div>
          ...
          <div className="pt-2">
            <Button
              ...
              className="w-full justify-center tracking-wider uppercase font-semibold text-xs"
              icon={<Send size={13} />}
            >
          ...
          <div className="pt-2 border-t border-white/[0.08] flex items-center justify-between text-[10px] text-ivory-muted/60">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-champagne-300 hover:text-champagne-200 uppercase tracking-wider flex items-center gap-1 font-medium"
            >
